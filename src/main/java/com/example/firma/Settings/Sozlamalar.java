...
import com.example.firma.Filter.Filter;
...
public class Sozlamalar extends WebSecurityConfigurerAdapter {
    ...
    public JavaMailSender getJavaMailSender(){
        ...
        mailSender.setUsername("botirovzuhriddin1202@gmail.com");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/firma/emailniTasdiqlash","/firma/login","/firma/vazifa").permitAll()
                .anyRequest()
                .authenticated();
